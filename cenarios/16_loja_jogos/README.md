# TED 01 — Loja de Jogos

**Cenário 16**

## Situação

Analise vendas de jogos, considerando gênero, plataforma, quantidade vendida, avaliação e duração.
...
- Calcular a média de avaliação por gênero e plataforma.
- Usar conjuntos para comparar jogos vendidos em duas plataformas e identificar gêneros ou títulos em comum.
