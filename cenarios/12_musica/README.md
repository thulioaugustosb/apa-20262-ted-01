# TED 01 — Aplicativo de Música

**Cenário 12**

## Situação

Analise reproduções de músicas, relacionando usuários, artistas, gêneros, músicas e quantidade de reproduções.
...
- Identificar artistas e músicas mais ouvidos.
- Calcular o total de reproduções por gênero.
- Usar conjuntos para comparar usuários que ouviram dois gêneros diferentes e identificar ouvintes em comum.
