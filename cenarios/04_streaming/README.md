# TED 01 — Streaming de Filmes e Séries

**Cenário 04**

## Situação

Analise o consumo de conteúdos de uma plataforma de streaming, relacionando usuários, títulos, gêneros, visualizações e avaliações.
...
- Identificar os conteúdos mais assistidos.
- Calcular a avaliação média por gênero.
- Usar conjuntos para comparar usuários que assistiram a dois gêneros diferentes, identificando usuários em comum.
