# TED 01 — Atendimento ao Cliente

**Cenário 13**

## Situação

Analise chamados de atendimento ao cliente, considerando categorias, atendentes, prioridades, status e tempo de atendimento.
...
- Identificar as categorias de chamados mais frequentes.
- Encontrar atendentes com maior volume e maior tempo médio de atendimento.
- Usar conjuntos para comparar clientes de duas categorias de chamados e identificar clientes em comum.
